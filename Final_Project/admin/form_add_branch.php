  ...
  <body>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <form action="add_branch.php" class="col-5" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between"><button type="submit" name="submit"class="btn btn-primary">Thêm</button><a href="./branch.php" class="btn btn-danger">Hủy</a></div>
            </form>
        </div>
    </div>
