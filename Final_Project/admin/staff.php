                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="./form_edit_staff.php?id=<?php echo $id?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                            <td><a href="./delete_staff.php?id=<?php echo $id?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
              <?php 
                    }
                }
